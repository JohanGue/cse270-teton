...
class TestSmokeTest():
  ...
  def test_directorypage(self):
    ...
    element = self.driver.find_element(By.ID, "directory-list")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    assert self.driver.find_element(By.CSS_SELECTOR, ".gold-member:nth-child(9) > p:nth-child(2)").text == "Teton Turf and Tree"
  ...
  def test_joinPage(self): 
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Guerrero")
    self.driver.find_element(By.NAME, "bizname").send_keys("Weglon")
  ...
  def test_adminpage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("adfasdf")
    self.driver.find_element(By.ID, "password").send_keys("adfasdf")
